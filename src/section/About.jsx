...
const About = () => {
	return (
		<motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="max-w-126.5 mt-39.5!">
			...
			<button className="text-[20px] mb-5 font-medium rounded-xs hover:rounded-3xl bg-(--gray-200) py-2.25 px-5.25 duration-200 hover:bg-(--gray-900) hover:text-(--gray-50)">Download Resume</button>
